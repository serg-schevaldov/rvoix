 ...
 */
 ...
 /* Module for msm7k devices with missing built-in vocpcm support */
...
#include <mach/msm_rpcrouter.h>
 ...
 /* Be sure to set proper values for these 3 constants according to your AMSS/RPC versions. 
    Check mach/msm_rpc_version.h if you have it. */
...
#include <mach/msm_rpc_version.h>
 ...
 /* It _might_ be necessary to remove this one and all references to it entirely. */
